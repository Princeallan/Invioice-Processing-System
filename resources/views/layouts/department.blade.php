        ...
        <div id="app-dashboard-sidebar"
            ...
            <div class="app-dashboard-sidebar-inner">
                <ul class="menu vertical">
                    <li>
                        <a href="{{route('department/approvals')}}" class="is-active">
                            <i class="fa fa-tachometer" aria-hidden="true"></i><span class="app-dashboard-sidebar-text">Dept Approvals</span>
                        </a></li>
